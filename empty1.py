...
def plot_bands(nbands, nktot, ak, energ, kv, color, size=10):
    ...
    for i in range(nbands):
       #plt.plot(ak,energ[i,:],linestyle='dotted',color=color, linewidth=size)  # use this to plot with lines
       plt.plot(ak,energ[i,:],'o',marker='.', color=color, markersize=size)     # use this to plot with points

#   inser fcc Brillouin zone
    #arr_bz = mpimg.imread('bz.jpeg')
