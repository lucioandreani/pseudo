...
set xtics ('L'0.00000,'{/Symbol G}'0.26401,'X'0.56887,'U,K'0.67665,'{/Symbol G}'1.00000)
...
# set xtics ('{/Symbol G}'0.,'X'0.2228,'W'0.3343,'L' 0.4919,'{/Symbol G}'0.6848,'K,U'0.8212,'X'1.0000)
set style data lines


set arrow from 0.26401, graph 0 to 0.26401, graph 1 nohead lt 0 lw 2
set arrow from 0.56887, graph 0 to 0.56887, graph 1 nohead lt 0 lw 2
set arrow from 0.67665, graph 0 to 0.67665, graph 1 nohead lt 0 lw 2


# plot 'pseudo.out'us 1:5 w p pt 7 ps 0.6, 'pseudo_vl.out' w l lt 3
 plot 'pseudo.out'us 1:5 w l lt 1 lw 2


# plot 'pseudo.out'us 1:5 w l lt 1 lw 2, 'pseudo_vl.out' w l lt 3
...
#set style line 2  lt 1 lw 2 pt 7 ps 0.6 lc rgb "black" 
 ...
 plot  'pseudo.out'us 1:5  w l ls 1, 'pseudo_vl.out' w l lt 3

 set key top left
 show key

# plot  'pseudo_gmax3.0.out'us 1:5  w l ls 1, \
#       'pseudo_gmax5.0.out'us 1:5  w l ls 2, \
#       'pseudo_g4.out'us 1:5  w l ls 4, \
