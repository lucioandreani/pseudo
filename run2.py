...
linewidth=2
line='True'
xlegend,ylegend=0.4,0

gmax_array=(2.,3.,4.,5.,6.,7.,8.)
color_array=('green','red','blue','cyan','green','red','blue','cyan')
plt.figure(figsize=(6,6))


i=0
for gmax,color in zip(gmax_array,color_array):
    print('calculating bands for gmax=', gmax)
    T=[gmax]
    label='gmax='+str(T[0])
    i=i+1
    plt.figure(i)   #  uncomment to keep separate figures
    execute_code(T)
    ...
    plt.text(xlegend, ylegend, 'gmax='+str(T[0]), fontsize=20)
